...
class AccountRatedMoviesResponse extends JsonSerializableType
{
    /**
     * @var ?int $page
     */
    ...
    /**
     * @var ?array<AccountRatedMoviesResponseResultsItem> $results
     */
    #[JsonProperty('results'), ArrayType([AccountRatedMoviesResponseResultsItem::class])]
     ...
     * @param array{
     *   page?: ?int,
     *   results?: ?array<AccountRatedMoviesResponseResultsItem>,
     *   totalPages?: ?int,
     *   totalResults?: ?int,
     * } $values
     */
