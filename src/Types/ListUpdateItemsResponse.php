...
class ListUpdateItemsResponse extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?array<ListUpdateItemsResponseResultsItem> $results
     */
    #[JsonProperty('results'), ArrayType([ListUpdateItemsResponseResultsItem::class])]
     ...
     *   results?: ?array<ListUpdateItemsResponseResultsItem>,
     *   success?: ?bool,
     *   statusCode?: ?int,
     * } $values
     */
