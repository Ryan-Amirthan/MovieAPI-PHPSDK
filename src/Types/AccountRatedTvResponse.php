...
class AccountRatedTvResponse extends JsonSerializableType
{
    /**
     * @var ?int $page
     */
    ...
    /**
     * @var ?array<AccountRatedTvResponseResultsItem> $results
     */
    #[JsonProperty('results'), ArrayType([AccountRatedTvResponseResultsItem::class])]
     ...
     * @param array{
     *   page?: ?int,
     *   results?: ?array<AccountRatedTvResponseResultsItem>,
     *   totalPages?: ?int,
     *   totalResults?: ?int,
     * } $values
     */
