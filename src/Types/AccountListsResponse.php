...
class AccountListsResponse extends JsonSerializableType
{
    /**
     * @var ?int $page
     */
    ...
    /**
     * @var ?array<AccountListsResponseResultsItem> $results
     */
    #[JsonProperty('results'), ArrayType([AccountListsResponseResultsItem::class])]
     ...
     * @param array{
     *   page?: ?int,
     *   results?: ?array<AccountListsResponseResultsItem>,
     *   totalPages?: ?int,
     *   totalResults?: ?int,
     * } $values
     */
