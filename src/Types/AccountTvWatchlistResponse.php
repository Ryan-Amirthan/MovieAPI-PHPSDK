...
class AccountTvWatchlistResponse extends JsonSerializableType
{
    /**
     * @var ?int $page
     */
    ...
    /**
     * @var ?array<AccountTvWatchlistResponseResultsItem> $results
     */
    #[JsonProperty('results'), ArrayType([AccountTvWatchlistResponseResultsItem::class])]
     ...
     * @param array{
     *   page?: ?int,
     *   results?: ?array<AccountTvWatchlistResponseResultsItem>,
     *   totalPages?: ?int,
     *   totalResults?: ?int,
     * } $values
     */
