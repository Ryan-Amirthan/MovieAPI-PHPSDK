...
class AccountRatedTvResponseResultsItem extends JsonSerializableType
{
    /**
     * @var ?bool $adult
     */
    ...
    /**
     * @var ?AccountRatedTvResponseResultsItemAccountRating $accountRating
     */
    #[JsonProperty('account_rating')]
    public ?AccountRatedTvResponseResultsItemAccountRating $accountRating;
     ...
     *   voteAverage?: ?float,
     *   voteCount?: ?int,
     *   accountRating?: ?AccountRatedTvResponseResultsItemAccountRating,
     * } $values
     */
